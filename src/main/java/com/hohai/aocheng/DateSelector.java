...
public class DateSelector extends JButton {
    ...
    private class DateChooser extends JPanel implements ActionListener,
        ...
        // 控制条配色------------------//
        Color controlLineColor = Color.darkGray; // 控制条底色
        ...
        private JPanel createMinuteAndsecondPanal() {
            ...
            hourSpin.setPreferredSize(new Dimension(60, 30));
            ...
            minuteSpin.setPreferredSize(new Dimension(60, 30));
            ...
            secondSpin.setPreferredSize(new Dimension(60, 30));
